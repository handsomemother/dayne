var regexEnum = 
{
	...
	num3:"^(([0-9]+[\.]?[0-9]{0,2})|[0-9])$",  //非负数（控制小数据点两位）
	decmal:"^([+-]?)\\d*\\.\\d+$",			//浮点数
	...
	usernameOrEmpty:"^\\w*$",				//用来用户注册。匹配由数字、26个英文字母或者下划线组成的字符串
	letter:"^[A-Za-z]+$",					//字母
	letter_u:"^[A-Z]+$",					//大写字母
	letter_l:"^[a-z]+$",					//小写字母
	idcard:"^[1-9]([0-9]{14}|[0-9]{17})$",	//身份证
	stbuid:"[0-9a-fA-F]+$",					//十六进制数
	isurl:"[a-zA-z]+://[^s]*" //校验url
}
	...
	if (InString) {
		...
		for (Count = 0; Count < InString.length; Count++) {
			...
			if ((RefString.indexOf(TempChar, 0) == 0)
				...
				return "您输入的 \""+InString+"\" 中含有非法字符(< ,\ ,% ,> ,~ ,& ,? ,',_ ),请重新输入!";
			}
		}
	}
	return true;
